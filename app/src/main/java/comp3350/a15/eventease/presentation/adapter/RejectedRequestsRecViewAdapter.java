...
public class RejectedRequestsRecViewAdapter extends RecyclerView.Adapter<RejectedRequestsRecViewAdapter.ViewHolder> {

    private final IRequestsRecView requestsRecViewInterface;
    private List<ServiceRequest> requestList;

    public RejectedRequestsRecViewAdapter(List<ServiceRequest> allRequests, IRequestsRecView requestsRecViewInterface) {
        super();
    ...
    @NonNull
    @Override
    public RejectedRequestsRecViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.service_request_item,
                parent, false);
        return new RejectedRequestsRecViewAdapter.ViewHolder(view, requestsRecViewInterface);
    }

    @Override
    public void onBindViewHolder(@NonNull RejectedRequestsRecViewAdapter.ViewHolder holder, int position) {
