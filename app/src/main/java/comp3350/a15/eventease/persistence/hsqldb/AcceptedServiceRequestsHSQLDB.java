...
public class AcceptedServiceRequestsHSQLDB extends ServiceRequestPersistenceHSQLDB {
    @Inject
    public AcceptedServiceRequestsHSQLDB(@Named("dbPathName") String DBPathName, IServiceRequestFactory serviceRequestFactory,
    ...
    public List<ServiceRequest> getAllRequests(int vendorId) {
        ...
        try (Connection connection = connect();
            ...
            stmt.setString(2, ServiceRequest.ServiceStatus.ACCEPTED.name());
